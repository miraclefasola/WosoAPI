...
class ClubSeasonStatSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields= ['id','club','season','points_won','league_position','matches_played','win','draw','lost','goals_scored','goals_conceded','xg_created','xg_conceded','shots','shots_target','passes','passes_comp','passes_to_final_third','passes_to_pen_area' ]
...
class GoalkeeperSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model= Goalkeeper
        fields=['player_name','club_name','season','age', 'matches_played', 'minutes_played','goals_conceded','shots_faced','saves','save_percentage','clean_sheets','psxg']
