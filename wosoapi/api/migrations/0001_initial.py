# Generated by Django 5.2.4 on 2025-09-08 12:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("total_clubs", models.IntegerField(blank=True, null=True)),
                (
                    "code",
            ...
            options={
                "constraints": [
                    models.UniqueConstraint(
                        ...
                        name="unique_player_season_club",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "position",
                    models.CharField(
                        blank=True, default="GK", max_length=20, null=True
                    ),
                ),
                ("age", models.SmallIntegerField(blank=True, null=True)),
                ("matches_played", models.IntegerField(blank=True, null=True)),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="goalkeeper_clubstats",
                        to="api.club",
                    ),
                ),
                (
