            ...
            for _, row in df.iterrows():
                try:
                    ...
                    stats_data = {
                        ...
                        'shots': row.get('shots'),
                        'shots_target': row.get('shots_on_target'),
                        'passes': row.get('passes'),
                        'passes_comp': row.get('passes_completed'),
                        'passes_to_final_third': row.get('passes_into_final_third'),
                        'passes_to_pen_area': row.get('passes_into_penalty_area'),
                    }
